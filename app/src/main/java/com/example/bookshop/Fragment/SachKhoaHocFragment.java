...
public class SachKhoaHocFragment extends Fragment {
...
//                ", Ten VARCHAR(150), MoTa VARCHAR(250), HinhAnh BLOB)");
        ...
        adapter = new SachKhoaHocDAO(SachKhoaHocFragment.this, R.layout.product_layout, sanPhamDTOArrayList);
