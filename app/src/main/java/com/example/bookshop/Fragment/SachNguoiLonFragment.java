...
public class SachNguoiLonFragment extends Fragment {
...
//                ", Ten VARCHAR(150), MoTa VARCHAR(250), HinhAnh BLOB)");
        ...
        adapter = new SachNguoiLonDAO(SachNguoiLonFragment.this, R.layout.product_layout, sanPhamDTOArrayList);
